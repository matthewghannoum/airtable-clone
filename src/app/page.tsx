        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm text-zinc-500">
              Continue with your Google account to access your workspaces and bases.
            </p>
          </div>
        </div>
            ...
            <span aria-hidden className="flex h-5 w-5 items-center justify-center">
              <svg viewBox="0 0 18 18" aria-hidden className="h-5 w-5">
                <g fill="none" fillRule="evenodd">
                  ...
                  />
                  <path
                    d="M3.964 10.713A5.41 5.41 0 0 1 3.682 9c0-.593.102-1.17.282-1.713V4.955H.957A9 9 0 0 0 0 9c0 1.452.348 2.825.957 4.045z"
                    fill="#FBBC05"
                  />
                  <path
